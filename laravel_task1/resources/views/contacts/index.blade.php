    ...
    <body>
        <nav>
          ...
          <div class="right-nav img">
            <img src="https://img.freepik.com/free-photo/close-up-view-impressed-young-handsome-caucasian-man-wearing-glasses-isolated-green-wall_141793-80002.jpg?size=626&ext=jpg&ga=GA1.1.690094248.1687858022&semt=ais" alt="logoimge" />
          </div>
        </nav>
            ...
            <ul>
              <ul class="flex">
                <li style="padding: 0px;">
                  ...
                  <div style="display: flex ;padding:1em;;"  ><i class="fa-solid fa-user" style="padding-top:8px;padding-right:8px;"></i><h4 style="padding:0px">STUDENTS</h4></div>
                  <div style="display: flex ;padding:1em;"  ><i class="fa-solid fa-chalkboard-user" style="padding-top:8px;padding-right:8px;"></i><h4 >STAFF</h4></div>
                  <div style="display: flex ;padding:1em;"  ><i class="fa-solid fa-graduation-cap" style="padding-top:8px;padding-right:8px;"></i><h4 >EXAMS</h4></div>
              </ul>
            </ul>
          </div>
